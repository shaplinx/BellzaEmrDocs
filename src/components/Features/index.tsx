            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
                    <div className="md:p-8 lg:p-14">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Dukungan Teknis</h3>
                        <p className="mt-5 text-base text-gray-600 font-pj">Layanan bantuan respon cepat memastikan Anda mendapatkan solusi cepat dan efektif untuk setiap masalah teknis.</p>
                    </div>
                    ...
                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Skalabilitas</h3>
                        <p className="mt-5 text-base text-gray-600 font-pj">Aplikasi dirancang untuk tumbuh bersama bisnis Anda, mendukung kebutuhan kecil hingga besar.</p>
                    </div>
                    ...
                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Cepat</h3>
                        <p className="mt-5 text-base text-gray-600 font-pj">Pengalaman super cepat tanpa reload, meningkatkan efisiensi dan kenyamanan pengguna.</p>
                    </div>
                    ...
                    <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Multiplatform</h3>
                        <p className="mt-5 text-base text-gray-600 font-pj">Dapat diakses dari perangkat apa pun, mendukung web, iOS, dan Android.</p>
                    </div>
                    ...
                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Pengalaman Terbaik</h3>
                        <p className="mt-5 text-base text-gray-600 font-pj">Antarmuka intuitif dan desain modern memberikan kenyamanan maksimal untuk pengguna.</p>
                    </div>
                    ...
                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Statistik</h3>
                        <p className="mt-5 text-base text-gray-600 font-pj">Data dan wawasan real-time membantu pengambilan keputusan strategis yang tepat.</p>
                    </div>
                </div>
            </div>
        </section>
